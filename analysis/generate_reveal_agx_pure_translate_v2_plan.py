...
OUTPUT_DEFAULT: Final = (
    ROOT / "build" / "analysis-agx-basis" / "pure-translate-plan-v2"
)
...
def geometries():
    out = []
    # Family A: o6 shape with DIFFERENT anchor y (y_in 400.5): x-translate
    for k in range(256):
        x0 = -530.0 - k / 256.0
        out.append(((x0 + 1049.0, 400.5), (x0 + 1049.0, 1449.5), (x0, 1449.5)))
    # Family B: o6 shape anchor y 900.25: x-translate
    for k in range(256):
        x0 = -530.0 - k / 256.0
        out.append(((x0 + 1049.0, 900.25), (x0 + 1049.0, 1949.25), (x0, 1949.25)))
    # Family C: o2 shape with anchor x 1200: y-translate
    for k in range(256):
        y0 = -530.0 - k / 256.0
        out.append(((1200.0, y0), (1200.0, y0 + 1184.0), (16.0, y0 + 1184.0)))
    return out
