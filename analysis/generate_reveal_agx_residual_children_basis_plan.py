#!/usr/bin/env python3
"""Barycentric-basis capture: each vertex carries a one-hot basis value
so the exported A/B/C words ARE the per-vertex barycentric plane words.
...
OUTPUT_DEFAULT: Final = (
    ROOT / "build" / "analysis-agx-basis" / "residual-children-basis-plan-v1"
)
VERTEX: Final = struct.Struct("<8I")
SCRATCH: Final = Path(
    "/tmp/nix-shell.PFgUGF/claude-1000/-tmp-walle/"
    "4ccfbce8-33b2-4b5f-8e29-93486397c8a4/scratchpad")
NINE: Final = ((31, 6), (31, 103), (33, 6), (33, 103), (34, 2), (34, 6),
               (34, 104), (34, 106), (35, 2), (35, 104), (39, 6), (40, 2),
               (40, 104), (41, 2), (42, 2), (42, 6), (44, 6), (45, 2),
               (47, 2), (58, 4), (58, 5), (58, 106), (60, 4), (60, 106))
...
def load_children() -> dict:
    out = {}
    for line in (SCRATCH / "childgeo_all_residual_states.txt").read_text().splitlines():
...
def generate(output_directory: Path) -> dict:
            ...
            for tx in range(tx0, tx1 + 1):
                ...
                for vi, vertex in enumerate(verts):
                    ...
                    vertices.extend(VERTEX.pack(
                        vertex[0], vertex[1], 0, 0, *basis))
                experiments.append({
                    "recordIndex": record,
                    "inputOrdinal": record,
                    "variant": "residual-children-basis",
                    "split": "discovery",
                    "state": state,
                    "drawOrdinal": ordinal,
                    "anchor": an,
    ...
    plan_path.write_text(json.dumps(plan, indent=2, sort_keys=True) + "\n",
                         encoding="utf-8")
    manifest = {
        "schema": "walle-reveal-agx-residual-children-basis-plan-manifest-v1",
        "generator": {
