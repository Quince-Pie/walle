...
OUTPUT_DEFAULT: Final = (
    ROOT / "build" / "analysis-agx-basis" / "rate-tabulate-plan-v1"
)
...
def geometries():
    out = []
    # 16 o6-shape families: anchor y = 614.5 + n/16 px (n = 0..15), each
    # x-translated over 64 subpixel steps: rate(y-low-bits) tabulation.
    for n in range(16):
        y0 = 614.5 + n / 16.0
        for k in range(64):
            x0 = -530.0 - k / 256.0
            out.append(((x0 + 1049.0, y0), (x0 + 1049.0, y0 + 1049.0), (x0, y0 + 1049.0)))
    return out
