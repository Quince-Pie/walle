...
print(f"Rendering all {len(landmark_files)} Apple Landmark photo wallpapers using production WalleShaderRenderer (shaders/frag.glsl)...")
...
for bg_file in landmark_files:
    ...
    # Canvas alignment: 3200x2000 with wallpaper at (0,0) and 200px black right margin
    ...
    print(f"Saved clean GLSL render for Landmark {lid} ({out_img.size[0]}x{out_img.size[1]})")
