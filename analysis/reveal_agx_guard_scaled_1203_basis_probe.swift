    ...
    uint vertexID [[vertex_id]])
{
    ...
    output.clipDistance[0] = (2560.0f - position.x) * 0x1.0p-10f;
    output.clipDistance[1] = (position.y + 512.0f) * 0x1.0p-10f;
    output.clipDistance[2] = (position.x + 512.0f) * 0x1.0p-10f;
    output.clipDistance[3] = (2560.0f - position.y) * 0x1.0p-10f;
    return output;
}
    ...
    return (
        ...
        [
            ...
            "compile": [
                ...
                "clipDistances": [
                    "(2560-x)*2^-10", "(y+512)*2^-10", "(x+512)*2^-10", "(2560-y)*2^-10",
                ],
