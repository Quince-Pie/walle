...
OUTPUT_DEFAULT: Final = (
    ROOT / "build" / "analysis-agx-basis" / "c-truthtable-plan-v1"
)
VERTEX: Final = struct.Struct("<8I")
ROWS: Final = range(19, 64)
COLUMN: Final = 60

V0 = (0x44000000, 0x4419A000)   # (512, 614.5)
V1 = (0x45200000, 0x4419A000)   # (2560, 614.5)
V2 = (0x45200000, 0x45266800)   # (2560, 2662.5)
...
def probe_words():
    ...
    for w in list(words):                         # half-scale twins
        words.append(w - (1 << 23))               # exponent -1
    return words
