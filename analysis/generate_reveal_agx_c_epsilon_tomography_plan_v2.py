...
one binade so the lever is strictly monotone (v1 showed exponent-snap
artifacts at |j|=16); step ~ G/51, span ~1.25G, all-positive.
...
OUTPUT_DEFAULT: Final = (
    ROOT / "build" / "analysis-agx-basis" / "c-epsilon-tomography-plan-v2"
)
...
def generate(output_directory: Path) -> dict:
    ...
    plan = {
        ...
        "authority": {
            ...
            "establishesCEpsilonTomographyV2": True,
        },
