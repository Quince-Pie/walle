#!/usr/bin/env python3
"""Wide-product epsilon tomography on the tt4 geometry.
...
OUTPUT_DEFAULT: Final = (
    ROOT / "build" / "analysis-agx-basis" / "c-epsilon-tomography-plan-v1"
)
...
def generate(output_directory: Path) -> dict:
    ...
    for t in T_VALUES:
        ...
        for ty in ROWS:
            ...
            k = (bl - 24) - 37 - 3
            for j in J_RANGE:
                eps_word = f32_word(1 if j >= 0 else -1, abs(j), k)
    ...
    plan = {
        ...
        "authority": {
            ...
            "establishesCEpsilonTomography": True,
        },
